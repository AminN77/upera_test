...
type Service interface {
	...
	FetchRevisionsOfOneProduct(productID int64, ctx context.Context) ([]*Revision, error)
}
...
func (s *service) FetchRevisionsOfOneProduct(productID int64, ctx context.Context) ([]*Revision, error) {
	rev, err := s.repo.GetRevisionsOfOneProduct(productID, ctx)
	if err != nil {
		log.Println(err)
		return nil, ErrRepo
	}
